...
<form action='actionInitialiserEdition.php' method='post' enctype='multipart/form-data'>
    <div class="arrierePlanRectangle">
        ...
        <div class="rectangleJaune " style="background-color: <?php echo $couleur4 ?>; color: <?php echo $couleur7 ?>;">
            ...
            <label type="text" class="labelForm moyenLabelFormInitialisationSlide3">Ajouter une personne manuellement en entrant toutes ses informations :</label>
            <div class="ajoutManuelPosition">
                <div class="ligneInfoPersonne" style="border-color:<?php echo $couleur7 ?>;" style='margin-top:1%;'>
